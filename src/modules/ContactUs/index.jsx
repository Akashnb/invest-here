    ...
    <div className="max-w-md md:max-w-6xl mx-auto h-full">
      ...
      <div className="max-w-2xl mx-auto bg-white">
        <form className="p-12 space-y-5">
          ...
          <div>
            <div className="flex flex-col">
              ...
              <textarea
                ...
                cols="30"
                rows="7"
                class="appearance-none border w-full py-2 px-3 focus:outline"
          ...
          <button
            type="button"
            className="relative transition bg-accentMain px-8 py-3 rounded-full text-white text-base shadow-accentMain hover:shadow-accentMainHover hover:-top-px"
          >
            Send Message
          </button>
        </form>
